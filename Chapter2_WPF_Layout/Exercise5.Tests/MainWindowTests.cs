...
{
    [ExerciseTestFixture("progAdvNet", "H02", "Exercise05", @"Exercise5\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        {
            Assert.That(_allButtons.All(button => button.Content != null && button.Content != String.Empty), Is.True, "All buttons should have a Content");
