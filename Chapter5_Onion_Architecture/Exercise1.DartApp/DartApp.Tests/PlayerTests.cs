...
namespace DartApp.Tests
{
    ...
    public class PlayerTests : TestBase
    {
        ...
        [MonitoredTest]
        public void ShouldImplementIPlayer()
        {
            Assert.That(typeof(IPlayer).IsAssignableFrom(_playerType), Is.True);
        }

        [MonitoredTest]
        public void ShouldNotHaveChangedIPlayer()
        {
        ...
        [MonitoredTest]
        public void ShouldHaveAConstructorThatAcceptsAName()
        {
        ...
        [MonitoredTest]
        public void ToString_ShouldReturnAStringContainingName()
        {
            string name = Guid.NewGuid().ToString();
        ...
        [MonitoredTest]
        public void AddGameResult_ShouldAddTheGameResult()
        {
            //Arrange
            string name = Guid.NewGuid().ToString();
            IPlayer player = CreatePlayer(name);
        ...
        [MonitoredTest]
        public void GetPlayerStats_ShouldCalculateStatsCorrectly()
        {
            //Arrange
            string name = Guid.NewGuid().ToString();
            IPlayer player = CreatePlayer(name);
