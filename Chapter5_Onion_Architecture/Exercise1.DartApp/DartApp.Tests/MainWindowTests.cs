...
namespace DartApp.Tests
{
    ...
    public class MainWindowTests
    {
        ...
        [MonitoredTest]
        public void Constructor_ShouldRetrieveAllPlayersAndSetupDataBinding()
        {
        ...
        [MonitoredTest]
        public void SelectedPlayer_ShouldNotifyChanges()
        {
            //Arrange
        ...
        [MonitoredTest]
        public void ComboBoxSelection_ShouldSetSelectedPlayer()
        {
            ...
            Assert.That(comboBox!.Items.Count, Is.GreaterThan(0),
                ...
                $"Maybe you need to make the test '{nameof(Constructor_ShouldRetrieveAllPlayersAndSetupDataBinding)}' green first.");
        ...
        [MonitoredTest]
        public void AddPlayerButtonClick_ShouldUseTheServiceAndUpdateTheUI()
        {
        ...
        [MonitoredTest]
        public void AddGameResultButtonClick_ShouldAddAGameResultToListAndUpdateUI()
        {
            AddPlayerButtonClick_ShouldUseTheServiceAndUpdateTheUI();
        ...
        [MonitoredTest]
        public void CalculateStatisticsButtonClick_ShouldTriggerPLayerService()
        {
            AddPlayerButtonClick_ShouldUseTheServiceAndUpdateTheUI();
