...
{
    [ExerciseTestFixture("progAdvNet", "H01a", "Exercise06", 
    ...
    public class MainWindowTests
    {
        ...
        [MonitoredTest("Should have a textbox and 10 digit buttons")]
        public void _1_ShouldHaveATextBoxAnd10DigitButtons()
        {
            AssertHasAllControls();
        }

        [MonitoredTest("Should handle all button click events once by using event bubbling")]
        public void _2_ShouldHandleAllButtonClickEventsOnceByUsingEventBubbling()
        {
            AssertHasAllControls();

            var xamlCode = Guts.Client.Core.TestTools.Solution.Current.GetFileContent(@"Exercise6\MainWindow.xaml");
        ...
        [MonitoredTest("Should append digits to the textbox when buttons are clicked")]
        ...
        [MonitoredTest("Should allow appending digits to the textbox when typing")]
        ...
        [MonitoredTest("Should avoid appending non-digits to the textbox when typing")]
