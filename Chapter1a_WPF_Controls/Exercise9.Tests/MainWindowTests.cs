...
{
    [ExerciseTestFixture("progAdvNet", "H01a", "Exercise09", @"Exercise9\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        public void _1_ShouldNotHaveChangedTheCodebehindFile()
        {
            ...
            Assert.That(fileHash, Is.EqualTo("CD-E2-B9-52-E2-27-AE-E9-91-04-C4-8D-80-26-56-5C"), () =>
