...
{
    [ExerciseTestFixture("progAdvNet", "H01a", "Exercise2", @"Exercise2\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        {
            var filePath = @"Exercise2\MainWindow.xaml.cs";
        ...
        [MonitoredTest("Should have a button with a bigger fontsize in the middle")]
