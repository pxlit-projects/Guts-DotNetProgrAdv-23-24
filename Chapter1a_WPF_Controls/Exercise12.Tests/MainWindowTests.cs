...
{
    [ExerciseTestFixture("progAdvNet", "H01a", "Exercise12", @"Exercise12\MainWindow.xaml")]
    ...
    public class MainWindowTests
    {
        ...
        public void _1_ShouldNotHaveChangedTheCodebehindFile()
        {
            ...
            Assert.That(fileHash, Is.EqualTo("CE-B1-EE-C4-69-82-6E-02-86-ED-D7-5C-F1-67-E9-2F"), () => $"The file '{codeBehindFilePath}' has changed. " +
                                                                             "Undo your changes on the file to make this test pass. " +
                                                                             "This exercise can be completed by purely working with XAML.");
        }

        [MonitoredTest("Should have an outer StackPanel")]
        ...
        [MonitoredTest("Should have a language GroupBox")]
        ...
        [MonitoredTest("Should have a color ListView")]
        ...
        [MonitoredTest("Should have a style for all RadioButtons in the Window")]
